...
const BreakShift = ({navigation}) => {
  const {loading, setLoading,startEndBreakShiftRequest} = useDriverShiftServiceHook();
  ...
  <ImageBackground source={actionshiftbg} style={styles.imageBackground}>
    <View style={styles.mainContainer}>
      ...
      <TouchableOpacity style={styles.cardContainer}>
         <View style={{flex:1}}>
         <ButtonContainer layout="2"  handleNavigation={props.labels.handleBreakNavigation}
           buttonLabel={props.labels.buttonLabel1} {...props.labels} />
